...
import UserRegesterModal from '../../components/Form/UserRegesterModal';
...
CategoryPagesCard.propTypes = {
  file: PropTypes.object.isRequired,
  // index: PropTypes.number,
};

export default function CategoryPagesCard({ file }) {
  ...
  return (
    <Grid item xs={12} sm={latestFileLarge ? 12 : 6} md={latestFileLarge ? 6 : 3}>
