...
const ProfileCover = ({ user }) => {
  ...
  const handleUploadImage = async () => {
    const url = `${process.env.REACT_APP_API_KEY}/api/uploadImage/${userInfo?.id}`;
  ...
  return (
    <>
      ...
      <CardCover>
        ...
        <CardCoverAction>
          <Input accept="image/*" id="change-cover" type="file" name='image' formEncType='multipart/form-data' />
      ...
      <AvatarWrapper>
        <Avatar variant="rounded" alt={user.name} src={imagePanel} />
        <ButtonUploadWrapper>
          <Input
            type="file"
